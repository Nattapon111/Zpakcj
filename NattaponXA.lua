...
spawn(function() 
    ...
    wait(1.5)
    require(game.ReplicatedStorage.Notification).new("<Color=Red>Nattapon hub เราเป็นค่ายฟรีเจ้าใหม่<Color=/>"):Display()
    wait(.5)
...
local M = Window:MakeTab({
    Name = "⚔ฟาร์ม",
    Icon = "rbxassetid://15712703260",
    PremiumOnly = false
})

local ST = Window:MakeTab({
    Name = "⚙️ตั้งค่า",
    Icon = "rbxassetid://15712711639",
    PremiumOnly = false
})

local IQ = Window:MakeTab({
    Name = "⚔️ ไอเท็ม&เครวส",
    Icon = "rbxassetid://15806749681",
    PremiumOnly = false
})

local S = Window:MakeTab({
    Name = "📊ค่าพลัง",
    Icon = "rbxassetid://15712723981",
    PremiumOnly = false
})
...
local RA = Window:MakeTab({
    Name = "🎇ลงดัน",
    Icon = "rbxassetid://15712763124",
    PremiumOnly = false
})

local LC = Window:MakeTab({
    Name = "🏝เทเลพอร์ต ไปเกาะต่างๆ",
    Icon = "rbxassetid://15712738876",
    PremiumOnly = false
})

local Wld = Window:MakeTab({
    Name = "🚪เทเลพอร์ต โลกอื่น",
    Icon = "rbxassetid://15712738876",
    PremiumOnly = false
})
...
W:AddLabel("Nattapon hub SCRIPT")
W:AddLabel("Discord Nattapon hub")
local Section = W:AddSection({
    Name = "Status"
})
...
pcall(function()
    while wait() do
        if _G.AutoEliteHunter then
            if game:GetService("Players").LocalPlayer.PlayerGui.Main.Quest.Visible == true then
                OrionLib:MakeNotification({
                    Name = "Nattapon hub(Noitification)",
